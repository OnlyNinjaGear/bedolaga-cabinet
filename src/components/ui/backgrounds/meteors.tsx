  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      {meteors.map((meteor) => (
        <span
          key={meteor.id}
          className="animate-meteor-effect absolute top-0 rotate-[215deg] rounded-full"
          style={{
            left: meteor.left,
        ...
        >
          <div
            className="pointer-events-none absolute top-1/2 -z-10 h-px w-12.5 -translate-y-1/2"
            style={{
